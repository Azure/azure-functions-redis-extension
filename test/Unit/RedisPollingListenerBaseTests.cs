...
namespace Microsoft.Azure.WebJobs.Extensions.Redis.Tests.Unit
{
    public class RedisPollingListenerBaseTests
    {
        ...
        {
            RedisPollingTriggerBaseListener listener = new RedisListsListener(connectionString, keys, defaultPollingInterval, defaultMessagesPerWorker, defaultCount, false, A.Fake<ITriggeredFunctionExecutor>());
        ...
        {
            RedisPollingTriggerBaseListener listener = new RedisListsListener(connectionString, keys, defaultPollingInterval, messagesPerWorker, defaultCount, false, A.Fake<ITriggeredFunctionExecutor>());
