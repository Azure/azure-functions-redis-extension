...
namespace Microsoft.Azure.WebJobs.Extensions.Redis.Tests.Integration
{
    public static class ListTrigger_Single_RedisValue
    {
        ...
        public static void Run(
            [RedisListTrigger(IntegrationTestHelpers.ConnectionString, nameof(ListTrigger_Single_RedisValue), IntegrationTestHelpers.PollingIntervalShort)] RedisValue entry,
            ILogger logger)
        {
