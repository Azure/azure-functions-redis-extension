...
namespace Microsoft.Azure.WebJobs.Extensions.Redis
{
    ...
    public class RedisStreamTriggerAttribute : RedisPollingTriggerBaseAttribute
    {
        ...
        public RedisStreamTriggerAttribute(string connectionStringSetting, string keys, int pollingIntervalInMs = 1000, int messagesPerWorker = 100, int count = 10, string consumerGroup = "AzureFunctionRedisExtension", bool deleteAfterProcess = false)
            : base(connectionStringSetting, keys, pollingIntervalInMs, messagesPerWorker, count)
        {
