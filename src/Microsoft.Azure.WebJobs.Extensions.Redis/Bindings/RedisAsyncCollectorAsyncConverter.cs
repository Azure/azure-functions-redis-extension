...
namespace Microsoft.Azure.WebJobs.Extensions.Redis
{
    ...
    internal class RedisAsyncCollectorAsyncConverter : IAsyncConverter<RedisAttribute, IAsyncCollector<string>>
    {
        ...
        {
            IConnectionMultiplexer multiplexer = await RedisExtensionConfigProvider.GetOrCreateConnectionMultiplexerAsync(configuration, input.ConnectionStringSetting, RedisUtilities.RedisOutputBinding);
