...
namespace Microsoft.Azure.WebJobs.Extensions.Redis
{
    ...
    internal class RedisPubSubTriggerBindingProvider : ITriggerBindingProvider
    {
        ...
        public Task<ITriggerBinding> TryCreateAsync(TriggerBindingProviderContext context)
        {
            ...
            return Task.FromResult<ITriggerBinding>(new RedisPubSubTriggerBinding(configuration, azureComponentFactory, attribute.Connection, channel, attribute.Pattern, parameter.ParameterType, logger));
        }
    }
}
